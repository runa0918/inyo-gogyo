...
// ========= 運命数→十干/属性 =========
const UNMEI_MAP = {
  1: { jikkan: "甲（きのえ）", attr: "木の陽" },
  2: { jikkan: "乙（きのと）", attr: "木の陰" },
  3: { jikkan: "丙（ひのえ）", attr: "火の陽" },
  4: { jikkan: "丁（ひのと）", attr: "火の陰" },
  5: { jikkan: "戊（つちのえ）", attr: "土の陽" },
  6: { jikkan: "己（つちのと）", attr: "土の陰" },
  7: { jikkan: "庚（かのえ）", attr: "金の陽" },
  8: { jikkan: "辛（かのと）", attr: "金の陰" },
  9: { jikkan: "壬（みずのえ）", attr: "水の陽" },
...
const NATURE = {
  ...
  "火の陽": "情熱と突破力。前に出て場を明るくできる。勢いを活かすと強い。",
  "火の陰": "感性と表現力。空気を読んで魅せるのが上手。繊細さが武器。",
  "土の陽": "安定と統率。任されるほど力が出る。現実的に物事を回せる。",
  "土の陰": "受容と面倒見。人の間をつなぐ調整役。堅実で信頼されやすい。",
  "金の陽": "決断と実行。白黒はっきり、品質重視。ルール作りや改善が得意。",
  "金の陰": "洗練と美意識。細部まで整える力。審美眼と分析力で精度を上げる。",
  "水の陽": "知性と行動。情報を掴むのが速く、動きながら最適化できる。",
